...
public class GlobalSettings {
	...
	public static final String SRC_ROUTER_RT_PATH = SRC_BASE_DIR + "R1/"; // ROUTER_1分钟文件夹路径
	public static final String SRC_ROUTER_MIN_PATH = SRC_BASE_DIR + "R5/"; // ROUTER_5分钟文件夹路径
	public static final String SRC_CUSTOMER_RT_PATH = SRC_BASE_DIR + "C1/"; // CUSTOMER_1分钟文件夹路径
	public static final String SRC_CUSTOMER_MIN_PATH = SRC_BASE_DIR + "C5/"; // CUSTOMER_1分钟文件夹路径
	public static final String SRC_GROUP_PATH = SRC_BASE_DIR + "G5/"; // RG_CUSTOMER_5分钟文件夹路径
	...
	public static final int SLEEP_TIME_MIN = 10000; // 10s
	public static final int SLEEP_TIME_RT = 1000;  // 1s
	
	/** 配置相关参数 **/
	public static final String ID_CONF_PATH = "/var/nflow/nc_device_list/"; //ip-id映射
